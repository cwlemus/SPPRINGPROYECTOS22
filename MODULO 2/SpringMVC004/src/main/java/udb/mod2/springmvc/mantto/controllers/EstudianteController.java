package udb.mod2.springmvc.mantto.controllers;
...
import udb.mod2.springmvc.mantto.entidades.Estudiante;
import udb.mod2.springmvc.mantto.servicios.EstudianteService;
...
public class EstudianteController {
	...
	public String formularioInsertarEstudiante(Model modelo, @ModelAttribute Estudiante estudiante) {
	...
	public @ResponseBody String formularioEditarEstudiante(@RequestParam("codigo") int codigo, Model modelo)
			throws IOException {
