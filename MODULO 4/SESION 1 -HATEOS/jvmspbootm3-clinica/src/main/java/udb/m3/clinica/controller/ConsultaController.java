			...
			consultas.stream().forEach(c -> {
				ConsultaDTO consultaDTO = new ConsultaDTO(
					...
					c.getFechaConsulta()
						...
						/*ControllerLinkBuilder pacienteLink = 
						linkTo(methodOn(PacienteController.class).mostrarPacienteById((c.getPaciente())));
						d.add(pacienteLink.withSelfRel());*/
				 Link selfLink = linkTo(methodOn(PacienteController.class).pacienteById(c.getPaciente().getIdPaciente())).withSelfRel();
				 consultaDTO.add(selfLink);
